    ...
    return {
      ...
      onStart: () => {
        ...
        if (hitter) {
          ...
          hitter.visible = true;
          // Back in the box. A swing is left standing at the end of itself so
          // the finish can be looked at - a whiff especially, which now spins
          // the hitter most of the way round - and the next pitch is the point
          // at which he has to have got up off it.
