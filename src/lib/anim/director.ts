      ...
      update: (t) => {
        ...
        if (t > flight.plateTime) {
          ...
          if (foul) {
            ...
            // twice the height the old hop reached, about fifty feet, which is
            // high enough to lose against the sky for a beat and still well
            // under the roof. It comes down where `foulBallFor` put it: four
            // feet inside the edge of foul ground, in front of the seats
            // rather than in them.
